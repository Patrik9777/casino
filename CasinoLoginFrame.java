...
public class CasinoLoginFrame extends JFrame {
        ...
        registerButton.addActionListener(e -> {
            ...
            if (username.isEmpty() || email.isEmpty() || password.isEmpty()) {
                JOptionPane.showMessageDialog(dialog, 
                    "<html><div style='text-align: center; color: black;'>Kérjük töltsd ki az összes mezőt!</div></html>", 
                    "Hiba", 
            ...
            if (userManager.registerUser(username, password, email)) {
                JOptionPane.showMessageDialog(dialog, 
                    "<html><div style='text-align: center; color: black;'>Sikeres regisztráció! Most már bejelentkezhetsz.</div></html>", 
                    "Sikeres regisztráció", 
                    JOptionPane.INFORMATION_MESSAGE);
                dialog.dispose();
            } else {
                JOptionPane.showMessageDialog(dialog, 
                    "<html><div style='text-align: center; color: black;'>A felhasználónév már foglalt!</div></html>", 
                    "Hiba", 
                    JOptionPane.ERROR_MESSAGE);
            }
        });
    ...
    private void showError(String message) {
        JOptionPane.showMessageDialog(
            this, 
            "<html><div style='text-align: center; color: black;'>" + message + "</div></html>", 
            "Hiba", 
            JOptionPane.ERROR_MESSAGE
        );
    }
